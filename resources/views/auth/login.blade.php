                                ...
                                <form method="POST" action="{{ url('/login') }}" class="needs-validation"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('tahun_ajaran') is-invalid @enderror"
                                            id="tahun_ajaran" type="text" name="tahun_ajaran"
                                            placeholder="@error('tahun_ajaran') {{ $message }} @enderror" required>
                                            <option value disable>Pilih Tahun Ajaran</option>
                                            @foreach (App\Models\Admin\TahunAjaran::all() as $item)
