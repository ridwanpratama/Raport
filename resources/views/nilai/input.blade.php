...
<div class="section-body">
    <div class="row">
        <div class="col-12 col-md-12 col-lg-12">
            <div class="card my-3">
                <div class="card-body">
                    <a id="add" href="javascript:;" class="btn btn-info addRow mx-2 my-2 float-right">+</a>
                    <a href="javascript:;" class="btn btn-danger deleteRow my-2 float-right">-</a>
                    ...
                    <table class="table table-sm"">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><input id=" Value" type="text" name="nilai">
                        </td>
